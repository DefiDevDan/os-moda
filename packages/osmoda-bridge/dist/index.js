...
const keyd_client_1 = require("./keyd-client");
const watch_client_1 = require("./watch-client");
const routines_client_1 = require("./routines-client");
const voice_client_1 = require("./voice-client");
const mesh_client_1 = require("./mesh-client");
const mcpd_client_1 = require("./mcpd-client");
const teachd_client_1 = require("./teachd-client");
// ---------------------------------------------------------------------------
// agentd Unix socket HTTP client
// ---------------------------------------------------------------------------
const AGENTD_SOCKET = process.env.OSMODA_SOCKET || "/run/osmoda/agentd.sock";
function agentdRequest(method, reqPath, body) {
...
function runExec(binary, args, timeout = 30000) {
    try {
...
function getAppUnitName(name) {
    return APP_UNIT_PREFIX + name.replace(/[^a-zA-Z0-9_-]/g, "-");
}
function getAppStatus(unitName) {
    try {
...
function validateRestartPolicy(policy) {
    if (!policy)
        return "on-failure";
    if (VALID_RESTART_POLICIES.includes(policy))
        return policy;
    return "on-failure";
}
...
function logToolExecution(toolName, params, output, success) {
    ...
    (0, teachd_client_1.teachdRequest)("POST", "/observe/action", {
        tool: toolName,
...
function register(api) {
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                ...
                if (params.type)
                    p.set("type", String(params.type));
                if (params.actor)
                    p.set("actor", String(params.actor));
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                const tags = typeof params.tags === "string" ? params.tags.split(",").map((t) => t.trim()) : [];
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                ...
                if (pathErr)
                    return { output: JSON.stringify({ error: pathErr, path: filePath }) };
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            const args = ["--no-pager"];
            if (params.unit)
                args.push("-u", sanitizeUnitName(String(params.unit)));
            if (params.priority)
                args.push("-p", sanitizePriority(String(params.priority)));
            if (params.since)
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, keyd_client_1.keydRequest)("POST", "/wallet/create", { chain: params.chain, label: params.label }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, keyd_client_1.keydRequest)("GET", "/wallet/list") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, keyd_client_1.keydRequest)("POST", "/wallet/sign", { wallet_id: params.wallet_id, payload: params.payload }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, keyd_client_1.keydRequest)("POST", "/wallet/send", { wallet_id: params.wallet_id, to: params.to, amount: params.amount }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, keyd_client_1.keydRequest)("POST", "/wallet/delete", { wallet_id: params.wallet_id }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("POST", "/switch/begin", {
                        plan: params.plan,
    ...
    api.registerTool(() => ({
        ...
        async execute() {
            try {
                return { output: await (0, watch_client_1.watchRequest)("GET", "/switch/list") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("GET", `/switch/status/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("POST", `/switch/commit/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("POST", `/switch/rollback/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("POST", "/watcher/add", params) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("GET", "/watcher/list") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, routines_client_1.routinesRequest)("POST", "/routine/add", params) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, routines_client_1.routinesRequest)("GET", "/routine/list") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, routines_client_1.routinesRequest)("POST", `/routine/trigger/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
        ...
        async execute(_id, params) {
            try {
                ...
                if (params.type)
                    p.set("type", String(params.type));
                if (params.since)
                    p.set("since", String(params.since));
                p.set("limit", String(params.limit || 50));
                return { output: await agentdRequest("GET", "/receipts?" + p.toString()) };
            }
            catch (e) {
    ...
    // =========================================================================
    const voiceClient = new voice_client_1.VoiceClient(process.env.OSMODA_VOICE_SOCKET || "/run/osmoda/voice.sock");
    // --- voice_status ---
    api.registerTool(() => ({
        name: "voice_status",
        label: "Voice Status",
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("GET", "/identity") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("POST", "/invite/create", { ttl_secs: params.ttl_secs }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("POST", "/invite/accept", { invite_code: params.invite_code }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("GET", "/peers") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("POST", `/peer/${params.peer_id}/send`, { message: params.message }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("DELETE", `/peer/${params.peer_id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("GET", "/health") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("POST", "/room/create", { name: params.name }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("POST", "/room/join", { room_id: params.room_id, peer_id: params.peer_id }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mesh_client_1.meshRequest)("POST", "/room/send", { room_id: params.room_id, text: params.text }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                ...
                return { output: await (0, mesh_client_1.meshRequest)("GET", "/room/history?" + p.toString()) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, mcpd_client_1.mcpdRequest)("GET", "/servers") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mcpd_client_1.mcpdRequest)("POST", `/server/${params.name}/start`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mcpd_client_1.mcpdRequest)("POST", `/server/${params.name}/stop`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, mcpd_client_1.mcpdRequest)("POST", `/server/${params.name}/restart`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("GET", "/health") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                ...
                return { output: await (0, teachd_client_1.teachdRequest)("GET", path) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", "/knowledge/create", params) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", "/teach", { context: params.context }) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", "/optimize/suggest") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", `/optimize/apply/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                ...
                return { output: await (0, teachd_client_1.teachdRequest)("GET", qpath) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", `/skills/generate/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", `/skills/promote/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", "/observe/action", params) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", "/skills/execution", params) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", "/skills/detect") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, _params) {
            try {
                return { output: await (0, teachd_client_1.teachdRequest)("POST", "/skills/verify") };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("POST", "/fleet/propose", {
                        plan: params.plan,
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("GET", `/fleet/status/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("POST", `/fleet/vote/${params.id}`, {
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, watch_client_1.watchRequest)("POST", `/fleet/rollback/${params.id}`) };
            }
            catch (e) {
                return { output: JSON.stringify({ error: e.message }) };
            }
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                return { output: await (0, keyd_client_1.keydRequest)("POST", "/wallet/build_tx", {
    ...
    api.registerTool(() => ({
        ...
        async execute(_id, params) {
            try {
                ...
                const restartPolicy = validateRestartPolicy(params.restart_policy);
                const args = [
                    "--unit", unitName,
                    "--service-type=simple",
                ...
                if (workingDir)
                    args.push(`--working-directory=${workingDir}`);
                if (params.memory_max)
                    args.push(`--property=MemoryMax=${String(params.memory_max)}`);
                if (params.cpu_quota)
                    args.push(`--property=CPUQuota=${String(params.cpu_quota)}`);
                // Environment variables
                const env = (params.env && typeof params.env === "object") ? params.env : {};
                for (const [k, v] of Object.entries(env)) {
                    const safeKey = k.replace(/[^a-zA-Z0-9_]/g, "");
                    if (safeKey)
                        args.push(`--setenv=${safeKey}=${v}`);
                }
                // The command + its args
                args.push("--", command);
                const cmdArgs = Array.isArray(params.args) ? params.args.map(String) : [];
                args.push(...cmdArgs);
        ...
        async execute(_id, params) {
            try {
                ...
                if (isActive) {
                    ...
                    if (app.working_dir)
                        args.push(`--working-directory=${app.working_dir}`);
                    if (app.memory_max)
                        args.push(`--property=MemoryMax=${app.memory_max}`);
                    if (app.cpu_quota)
                        args.push(`--property=CPUQuota=${app.cpu_quota}`);
                    if (app.env) {
